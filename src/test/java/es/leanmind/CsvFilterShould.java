...
class CsvFilterShould {
    ...
    void exclude_lines_with_non_decimal_tax_fields() {
        ...
        var incorrectLine = "1,02/05/2019,1000,810," + wrongTaxType + ",,ACER Laptop,B76430134,";
    ...
    void test_exclude_lines_with_both_taxes_even_with_wrong_format() {
        ...
        var incorrectLine = "1,02/05/2019,1000,810," + wrongIvaType + ",12,ACER Laptop,B76430134,";
